...
class _AdminUsersScreenState extends State<AdminUsersScreen> {
  String _query = '';
  String _role = 'Todos'; // Todos | Usuario | Administrador
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return ListTile(
                      ...
                      trailing: PopupMenuButton<String>(
                        ...
                        itemBuilder: (_) => const [
                          PopupMenuItem(value: 'pwd', child: ListTile(
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text('Usuario: ${u.name}', style: TextStyle(color: Theme.of(ctx).colorScheme.onSurface.withOpacity(.7))),
